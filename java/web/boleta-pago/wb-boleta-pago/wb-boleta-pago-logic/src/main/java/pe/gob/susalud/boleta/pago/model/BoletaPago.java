...
public class BoletaPago implements Serializable{
    ...
    public String deRegimen;
    public String noServidor;
    public String nuDocumento;
    public String deCargo;
    public String tiCondicion;
    public String deDependencia;
    public String noSueldo;
    public String deSueldo;
    public String feIngreso;
    public String noAfp;
    public String noEps;
    public String coAfiliacion;
    public String dePeriodo;
    public String nuEssalud;
    public String nuCuenta;
    public String noBanco;
    public String nuDias;
    public String nuHoras;
    public String fePago;
    public String toIngresos;
    public String toEgresos;
    public String toNeto;
    public String deMonto;
    public String deIngresos;
    public String deEgresos;
    public String deAportaciones;
    ...
    public String getDeIngresos() {
        return deIngresos;
    }

    public void setDeIngresos(String deIngresos) {
        this.deIngresos = deIngresos;
    }

    public String getDeEgresos() {
        return deEgresos;
    }

    public void setDeEgresos(String deEgresos) {
        this.deEgresos = deEgresos;
    }

    public String getDeAportaciones() {
        return deAportaciones;
    }

    public void setDeAportaciones(String deAportaciones) {
        this.deAportaciones = deAportaciones;
    }
