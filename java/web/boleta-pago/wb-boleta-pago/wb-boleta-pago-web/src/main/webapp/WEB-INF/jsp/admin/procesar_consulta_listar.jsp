...
<div  id="displayTagDivL" class="uk-overflow-container">

    <c:if test="${!empty listConsultaBoletas}">
        ...
        <table width="900"  class="uk-table uk-table-striped uk-text-nowrap">
            ...
            <tbody>
                  <c:forEach var="listar" items="${listConsultaBoletas}" varStatus="status">
                    <tr>                        
                        ...
                        <td align="center">
                            <a id="btnDescargar" href="#" onclick="javascript:descargaBoleta('${fn:trim(listar.nuSecuencial)}',' ${fn:trim(listar.rutaArchivo)}')" target="_blank"><img  alt="logo" title="Descargar" width="25px" height="25px" src="images/descargar_pdf.png">  </a> 
                        </td>
