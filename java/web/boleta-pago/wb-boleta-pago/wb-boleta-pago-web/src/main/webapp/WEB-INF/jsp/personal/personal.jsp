            ...
            <div class="menu_section">
                <ul>                                         
                    ...
                    <li> 
                        ...
                        <ul class="">                            
                            <li class="act_item"><a href="${pageContext.request.contextPath}/consultarPersonal.htm">Consultar Boletas</a></li>
                        </ul>
                   </li>
                     </c:if>  
                        ...
                        <div class="md-card">
                            <div class="md-card-content">
                                <ul class="uk-tab" data-uk-tab="{connect:'#tabs_anim1', animation:'scale'}">
                                    <li class="uk-active"><a href="#">Consultar Boleta</a></li>                                    
                                </ul>
                                <ul id="tabs_anim1" class="uk-switcher uk-margin">
                                    <li>
                                        <h3 class="heading_a">Detalle de Boletas</h3> <br />
                                        
                                        <!--form class="uk-form-3"-->
                                        <br />
                                        <form id="frmAjaxP" name="frmAjaxP" method="POST" action="">
                                            <input type="hidden" name="hddContext" id="hddContext" value="${pageContext.request.contextPath}"/>
                                            <!--<input type="hidden" name="hddNuDni" id="hddNuDni" value=""/>-->   
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                                                                    ...
                                                                                                    <div class="uk-grid">
                                                                                                        <div class="uk-width-small-11-1 uk-width-medium-1-1">
                                                                                                            <div class="uk-input-group"> 
                                                                                                                ...
                                                                                                                <input id="dniEmpl"  name="dniEmpl" type="text" class="input-count md-input" maxlength="8">
                                                ...
                                                <div class="uk-width-large-1-5 uk-width-medium-1-1">
                                                    <div class="uk-grid">
                                                        <div class="uk-width-small-11-1 uk-width-medium-1-1">
                                                            <div class="uk-input-group">                                                            
                                                                <a id="idConsultarPersonal" class="md-btn md-btn-primary" href="#" onclick="javascript:consultarPersonal()">Buscar</a>
                                                                <a id="idLimpiar" class="md-btn md-btn-primary"  href="${pageContext.request.contextPath}/consultarPersonal.htm">Limpiar</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="uk-width-large-1- uk-width-medium-1-1" style="height:300px; overflow:auto">                                            
                                            <div class="md-card-content">
                                                <div id="divResultadoP">
                                                    <div id="displayTagDivP"></div>
                                                </div>
                                            </div>                                            
                                        </div>                                         
                                    </li>                                                                       
